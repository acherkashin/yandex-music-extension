declare module "yandex-music-api" {
  class YandexMusicApi {
    ...
    init(config: { username: string; password: string }): Promise<InitResult>;
    ...
    getPlaylists(
      userId: string,
      playlists: string[],
      options: { mixed: string; "rich-tracks": string }
    ): any[];
    createPlaylist(name: string, options: { visibility: Visibility }): any;
